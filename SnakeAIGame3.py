...
class App:
    ...
    def on_loop(self):
        self.computer.target(self.player.x[0], self.player.y[0])
        self.player.update()
        ...
        # does snake collide with computer?
        for i in range(2,self.player.length):
            if self.game.isCollision(self.player.x[0],self.player.y[0],self.computer.x[i], self.computer.y[i],40):
